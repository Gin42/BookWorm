...
class AchievementRepository(private val achievementDAO: AchievementDAOs) {
    ...
    fun getAchievementById(achievementId: Long) : AchievementEntity = achievementDAO.getAchievementById(achievementId)
